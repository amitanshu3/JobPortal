  ...
  return (
    <div className="bg-slate-900 text-white">
      <div className="flex items-center justify-between mx-auto max-w-7xl h-16 px-4">
        ...
        <div
          className={`${
            menuOpen ? "absolute bg-slate-800 top-16 left-0 w-full z-10" : ""
          } flex-1 flex-col md:flex-row md:flex md:items-center justify-between gap-12 ${
            menuOpen ? "flex" : "hidden"
          } md:flex`}
        >
          <ul className="flex flex-col mt-6 gap-2 md:flex-row md:mt-0 font-medium items-center md:gap-5  ">
            {user && user.role === "recruiter" ? (
              ...
              <>
                ...
                <li>
                  <Link
                    to="/carrerbot"
                    className="bg-gradient-to-r from-[#FF512F] via-[#FF813B] to-[#FBB03B] text-white font-bold px-3 py-1 rounded"
                  >
                    CareerBot
                  </Link>
                </li>
